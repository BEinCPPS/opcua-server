<UaProfiles xsi:noNamespaceSchemaLocation="uaprofiles.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
 <ProjectInfo ProjectType="ServerProject" ProjectProfile="Standard" ScriptVersion="256" Version="1.2.336.256"/>
 <Categories>
 ...
 <ConformanceGroups>
  <ConformanceGroup description="Defines ConformanceUnits for various features of the OPC UA AddressSpace." name="Address Space Model">
   <ConformanceUnits>
    ...
    <ConformanceUnit category="Server" description="Support the NodeClasses with their Attributes and behaviour as defined in OPC UA Part 3. This includes for instance: Object, Object Type, Variable, Variable Type, References and Data Type" name="Address Space Base" used="true">
     ...
     <TestCases>
      <TestCase description="Walks through the address space checking each Node contains the mandatory attributes, references and properties. 250 nodes checked as defined by a constant at the top of the script." name="001.js" filename="Address Space Model/Address Space Base/Test Cases/001.js" checkedState="0"/>
  ...
  <ConformanceGroup description="Security related ConformanceUnits that can be profiled." name="Security">
   <ConformanceUnits>
    ...
    <ConformanceUnit category="Security" description="Certificate will be validated as specified in OPC UA Part 4. This includes among others structure and signature examination. Allowing for some validation errors to be suppressed by administration directive." name="Security Certificate Validation" used="true">
     <InitTestCase description="" name="initialize.js" filename="Security/Security Certificate Validation/Test Cases/initialize.js" checkedState="1"/>
     <TestCases>
      <TestCase description="Insecure channel. Activate a session. Validate certificate per specification. Expects successful connection and valid certificate." name="001.js" filename="Security/Security Certificate Validation/Test Cases/001.js" checkedState="1"/>
      <TestCase description="Secure channel. Untrusted certificate. Expects BadSecurityChecksFailed." name="005.js" filename="Security/Security Certificate Validation/Test Cases/005.js" checkedState="1"/>
      <TestCase description="Secure channel. Expired certificate. Expects Good or BadCertificateTimeInvalid" name="007.js" filename="Security/Security Certificate Validation/Test Cases/007.js" checkedState="1"/>
      <TestCase description="Secure channel. Not-yet-valid certificate. Expects Good or BadCertificateTimeInvalid." name="008.js" filename="Security/Security Certificate Validation/Test Cases/008.js" checkedState="1"/>
      <TestCase description="Secure channel. Issuer is unknown. Expects BadSecurityChecksFailed." name="009.js" filename="Security/Security Certificate Validation/Test Cases/009.js" checkedState="1"/>
      <TestCase description="Secure channel. Certificate signed with wrong key. Expects BadSecurityChecksFailed." name="010.js" filename="Security/Security Certificate Validation/Test Cases/010.js" checkedState="1"/>
      <TestCase description="Secure channel. Certificate contains incorrect IP/hostname. Expects Good or BadCertificateHostNameInvalid." name="011.js" filename="Security/Security Certificate Validation/Test Cases/011.js" checkedState="1"/>
      <TestCase description="Connect with expired/untrusted certificate" name="033.js" filename="Security/Security Certificate Validation/Test Cases/033.js" checkedState="1"/>
     </TestCases>
     <CleanupTestCase description="" name="cleanup.js" filename="Security/Security Certificate Validation/Test Cases/cleanup.js" checkedState="1"/>
    </ConformanceUnit>
    ...
    <ConformanceUnit category="Security" description="A suite of algorithms that uses RSA15 as Key-Wrap-algorithm and 128-Bit for encryption algorithms.&#xa;SymmetricSignatureAlgorithm&#x9;HmacSha1&#x9;(http://www.w3.org/2000/09/xmldsig#hmac-sha1)&#xa;SymmetricEncryptionAlgorithm&#x9;Aes128&#x9;(http://www.w3.org/2001/04/xmlenc#a" name="Security Basic 128Rsa15" used="true">
     <InitTestCase description="" name="initialize.js" filename="Security/Security Basic 128Rsa15/Test Cases/initialize.js" checkedState="1"/>
     <TestCases>
      <TestCase description="Create secure channel using Basic 128Rsa15; Sign only. Expects success." name="001.js" filename="Security/Security Basic 128Rsa15/Test Cases/001.js" checkedState="1"/>
      <TestCase description="Create secure channel using Basic 128Rsa15 Sign&amp;Encrypt. Expects success." name="002.js" filename="Security/Security Basic 128Rsa15/Test Cases/002.js" checkedState="1"/>
      <TestCase description="DoS attempt by consuming Channels" name="004.js" filename="Security/Security Basic 128Rsa15/Test Cases/004.js" checkedState="1"/>
      <TestCase description="DoS attack #2; consume SecureChannels, but CreateSessions in some." name="005.js" filename="Security/Security Basic 128Rsa15/Test Cases/005.js" checkedState="1"/>
     </TestCases>
     <CleanupTestCase description="" name="cleanup.js" filename="Security/Security Basic 128Rsa15/Test Cases/cleanup.js" checkedState="1"/>
    </ConformanceUnit>
    ...
    <ConformanceUnit category="Security" description="A suite of algorithms that 256-Bit for encryption algorithms&#xa;SymmetricSignatureAlgorithm&#x9;HmacSha1&#x9;(http://www.w3.org/2000/09/xmldsig#hmac-sha1)&#xa;SymmetricEncryptionAlgorithm&#x9;Aes256&#x9;(http://www.w3.org/2001/04/xmlenc#aes256-cbc)&#xa;AsymmetricSignatureAlgorit" name="Security Basic 256" used="true">
     ...
     <TestCases>
      ...
      <TestCase description="Create secure channel using Basic 256, but encrypt using 128Rsa15. Expects no response." name="003.js" filename="Security/Security Basic 256/Test Cases/003.js" checkedState="0"/>
    ...
    <ConformanceUnit category="Security" description="Long asymmetric keys." name="Security Basic 128LongRsa15" used="true">
     <InitTestCase description="" name="initialize.js" filename="Security/Security Basic 128LongRsa15/Test Cases/initialize.js" checkedState="0"/>
     <TestCases/>
     <CleanupTestCase description="" name="cleanup.js" filename="Security/Security Basic 128LongRsa15/Test Cases/cleanup.js" checkedState="0"/>
    </ConformanceUnit>
    <ConformanceUnit category="Security" description="Long asymmetric keys." name="Security Basic 256Long" used="true">
     <InitTestCase description="" name="initialize.js" filename="Security/Security Basic 256Long/Test Cases/initialize.js" checkedState="0"/>
     <TestCases/>
     <CleanupTestCase description="" name="cleanup.js" filename="Security/Security Basic 256Long/Test Cases/cleanup.js" checkedState="0"/>
    </ConformanceUnit>
    <ConformanceUnit category="Security" description="Encryption required by security algorithms." name="Security Encryption Required" used="true">
     <InitTestCase description="" name="initialize.js" filename="Security/Security Encryption Required/Test Cases/initialize.js" checkedState="1"/>
     <TestCases/>
     <CleanupTestCase description="" name="cleanup.js" filename="Security/Security Encryption Required/Test Cases/cleanup.js" checkedState="1"/>
    </ConformanceUnit>
    <ConformanceUnit category="Security" description="Signing required by security algorithms." name="Security Signing Required" used="true">
     <InitTestCase description="" name="initialize.js" filename="Security/Security Signing Required/Test Cases/initialize.js" checkedState="1"/>
     <TestCases/>
     <CleanupTestCase description="" name="cleanup.js" filename="Security/Security Signing Required/Test Cases/cleanup.js" checkedState="1"/>
    </ConformanceUnit>
  ...
  <ConformanceGroup description="An (OPC UA) Session is an application layer connection." name="Session Services">
   <ConformanceUnits>
    ...
    <ConformanceUnit category="Server" description="Support the Session Service Set (CreateSession, ActivateSession, CloseSession) except the use of ActivateSession to change the Session user.  This includes correct handling of all parameters that are provided.&#xa;&#xa;Note that for the CreateSession and Activa" name="Session Base" used="true">
     ...
     <TestCases>
      ...
      <TestCase description="ActivateSession: Specify different user-credentials activating an already active session." name="007.js" filename="Session Services/Session Base/Test Cases/007.js" checkedState="0"/>
      ...
      <TestCase description="" name="Err-007.js" filename="Session Services/Session Base/Test Cases/Err-007.js" checkedState="0"/>
  ...
  <ConformanceGroup description="Subscriptions are used to report Notifications to the Client." name="Subscription Services">
   <ConformanceUnits>
    ...
    <ConformanceUnit category="Server" description="Support at least 2 Subscriptions per Session." name="Subscription Minimum 02" used="true">
     ...
     <TestCases>
      ...
      <TestCase description="" name="Err-001.js" filename="Subscription Services/Subscription Minimum 02/Test Cases/Err-001.js" checkedState="0"/>
      <TestCase description="" name="Err-002.js" filename="Subscription Services/Subscription Minimum 02/Test Cases/Err-002.js" checkedState="0"/>
      <TestCase description="" name="Err-003.js" filename="Subscription Services/Subscription Minimum 02/Test Cases/Err-003.js" checkedState="0"/>
     </TestCases>
  ...
  <ConformanceGroup editable="true" description="User defined conformance group." name="UserDefinedCG">
   <ConformanceUnits>
    <ConformanceUnit editable="true" category="Server" description="User defined conformance unit." name="UserDefinedCU" used="true">
  ...
  <ConformanceGroup description="Clients use the View Service Set to navigate through the AddressSpace or through a View as subset of the AddressSpace." name="View Services">
   <ConformanceUnits>
 ...
 <Profiles>
  <Profile category="Server" description="specifies Auditing functionality for Servers." uri="http://opcfoundation.org/UA-Profile/Server/Auditing" name="Auditing Server Facet">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Auditing Base"/>
   </IncludeConformanceUnits>
   <IncludeProfiles>
  ...
  <Profile category="Server" description="specifies behavioural aspects that Servers shall follow for best use by operators and administrators. These aspects can only be tested in a test lab.  They are best practice guidelines." uri="http://opcfoundation.org/UA-Profile/Server/Behaviour" name="Base Server Behaviour Facet">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Protocol Configuration"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Security Administration - XML Schema"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Security Certificate Administration"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Security Administration"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Discovery Configuration"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  </Profile>
  <Profile category="Server" description="includes the ConformanceUnits to support redundant Clients." uri="http://opcfoundation.org/UA-Profile/Server/ClientRedundancy" name="Client Redundancy Facet">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Subscription Transfer"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  </Profile>
  <Profile category="Server" description="defines a set of ConformanceUnits that define Server specific handling of Complex Types." uri="http://opcfoundation.org/UA-Profile/Server/ComplexTypes" name="ComplexType Server Facet">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor Alternate Encoding"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Attribute Alternate Encoding"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Attribute Read Complex"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Address Space Complex Datatypes"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Attribute Write Complex"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  </Profile>
  <Profile category="Server" description="defines core functionality for all Servers.&#xa;This facet identifies Discovery, Session, AddressSpace and Viewing capabilities." uri="http://opcfoundation.org/UA-Profile/Server/CoreFacet" name="Core Server Facet">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Address Space Base"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Base Info Core Structure"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Base Info Server Capabilities"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Base Info Placeholder Modelling Rules"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Base Info OptionSet"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Base Info ValueAsText"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Attribute Read"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Attribute Write Values"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Attribute Write Index"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Discovery Get Endpoints"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Discovery Find Servers Self"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Security Administration"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Session General Service Behaviour"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Session Base"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Session Minimum 1"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="View Basic"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="View TranslateBrowsePath"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="View RegisterNodes"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="View Minimum Continuation Point 01"/>
   </IncludeConformanceUnits>
   <IncludeProfiles>
  ...
  <Profile category="Server" description="includes ConformanceUnits that define the handling of the DataAccess Information Model." uri="http://opcfoundation.org/UA-Profile/Server/DataAccess" name="DataAccess Server Facet">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Data Access AnalogItemType"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Data Access ArrayItemType"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Data Access ComplexNumber"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Data Access DataItems"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Data Access DoubleComplex Number"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Data Access MultiState"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Data Access PercentDeadBand"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Data Access Semantic Changes"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Data Access TwoState"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  </Profile>
  <Profile category="Server" description="includes the ConformanceUnits when supporting Embedded DataChange Subscription functionality." uri="http://opcfoundation.org/UA-Profile/Server/EmbeddedDataChangeSubscription" name="Embedded DataChange Subscription Server Facet">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor Basic"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor Value Change"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor Items 2"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor QueueSize_1"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Subscription Basic"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Subscription Minimum 1"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Subscription Publish Min 02"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Subscription Publish Discard Policy"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  </Profile>
  <Profile category="Server" description="focus is for devices with more than 50 Megabyte memory and with CPUs comparable to Intel 486 processor." uri="http://opcfoundation.org/UA-Profile/Server/EmbeddedUA" name="Embedded UA Server Profile">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Security Default ApplicationInstanceCertificate"/>
   </IncludeConformanceUnits>
   <IncludeProfiles>
    <IncludeProfile name="SecurityPolicy - Basic128Rsa15"/>
    <IncludeProfile name="Standard DataChange Subscription Server Facet"/>
    <IncludeProfile name="Micro Embedded Device Server"/>
    <IncludeProfile name="User Token - X509 Certificate Server Facet"/>
   </IncludeProfiles>
  </Profile>
  <Profile category="Server" description="defines the typical DataChange Subscription functionality to be provided by OPC UA Servers." uri="http://opcfoundation.org/UA-Profile/Server/EnhancedDataChangeSubscription" name="Enhanced DataChange Subscription Server Facet">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor Items 500"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor MinQueueSize_05"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Subscription Minimum 05"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Subscription Publish Min 10"/>
   </IncludeConformanceUnits>
   <IncludeProfiles>
    <IncludeProfile name="Standard DataChange Subscription Server Facet"/>
   </IncludeProfiles>
  ...
  <Profile category="Server" description="defines the functionality when supporting Subscription functionality for Events." uri="http://opcfoundation.org/UA-Profile/Server/EventSubscription" name="Event Subscription Server Facet">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor Complex Event Filter"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor QueueSize_1"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Subscription Publish Discard Policy"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor Events"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor Basic"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor Items 10"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Subscription Minimum 02"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Subscription Publish Min 05"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Subscription Basic"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  </Profile>
  <Profile category="Server" description="specifies the Method handling functionality for Servers." uri="http://opcfoundation.org/UA-Profile/Server/Methods" name="Method Server Facet">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Method Call"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Address Space Method"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  </Profile>
  <Profile category="Server" description="defines a Profile which is appropriate only for small devices with limited resources, including the inability to include a security infrastructure. It is expected that most applications will use gateways that enhance the functionality of these Servers to" uri="http://opcfoundation.org/UA-Profile/Server/MicroEmbeddedDevice" name="Micro Embedded Device Server">
   <IncludeConformanceUnits/>
   <IncludeProfiles>
    <IncludeProfile name="Nano Embedded Device Server Profile"/>
    <IncludeProfile name="Embedded DataChange Subscription Server Facet"/>
   </IncludeProfiles>
  </Profile>
  <Profile category="Server" description="specific functionality required in the smallest implementations" uri="http://opcfoundation.org/UA-Profile/Server/NanoEmbeddedDeviceServerProfile" name="Nano Embedded Device Server Profile">
   <IncludeConformanceUnits/>
   <IncludeProfiles>
    <IncludeProfile name="Core Server Facet"/>
  ...
  <Profile category="Server" description="includes the ConformanceUnits when supporting configuration of the AddressSpace through the OPC UA Node Management Service Set." uri="http://opcfoundation.org/UA-Profile/Server/NodeManagement" name="Node Management Server Facet">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Node Management Delete Ref"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Node Management Add Ref"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Node Management Delete Node"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Node Management Add Node"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Address Space Base"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  </Profile>
  <Profile category="Server" description="includes the ConformanceUnits for Servers with transparent redundancy." uri="http://opcfoundation.org/UA-Profile/Server/TransparentRedundancy" name="Redundancy Transparent Server Facet">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Redundancy Server Transparent"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  </Profile>
  <Profile category="Server" description="includes the ConformanceUnits for visible redundancy." uri="http://opcfoundation.org/UA-Profile/Server/VisibleRedundancy" name="Redundancy Visible Server Facet">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Redundancy Server"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  </Profile>
  <Profile category="Transport" description="defines a Stack Profile which represents the combination of HTTP/SOAP 1.2, WS-SecureConversation 1.3 and UA Binary 1.0 encoding." uri="http://opcfoundation.org/UA-Profile/Transport/soaphttp-wssc-uabinary" name="SOAP-HTTP WS-SC UA Binary">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Protocol Soap Binary WS Security"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  </Profile>
  <Profile category="Transport" description="defines a Stack Profile which represents the combination of HTTP/SOAP 1.2, WS-SecureConversation 1.3 and UA XML 1.0 encoding." uri="http://opcfoundation.org/UA-Profile/Transport/soaphttp-wssc-uaxml" name="SOAP-HTTP WS-SC UA XML">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Protocol Soap Xml WS Security"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  </Profile>
  <Profile category="Transport" description="defines a Stack Profile represents the combination of HTTP/SOAP 1.2, WS-SecureConversation 1.3 and UA XML 1.0 and UA Binary 1.0 encodings." uri="http://opcfoundation.org/UA-Profile/Transport/soaphttp-wssc-uaxml-uabinary" name="SOAP-HTTP WS-SC UA XML-UA Binary">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Protocol Soap Binary WS Security"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Protocol Soap Xml WS Security"/>
   </IncludeConformanceUnits>
  ...
  <Profile category="Security" description="defines a Security Policy for medium to highly secure configurations." uri="http://opcfoundation.org/UA/SecurityPolicy#Basic128Rsa15" name="SecurityPolicy - Basic128Rsa15">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Security Certificate Validation"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Security Basic 128Rsa15"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Security Encryption Required"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Security Signing Required"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  </Profile>
  <Profile category="Security" description="defines a Security Policy for configurations with high security needs." uri="http://opcfoundation.org/UA/SecurityPolicy/Basic256" name="SecurityPolicy - Basic256">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Security Certificate Validation"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Security Basic 256"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Security Encryption Required"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Security Signing Required"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  ...
  <Profile category="Security" description="defines a policy used for configurations with lowest security needs. This Security Policy can affect the behaviour of the CreateSession and Activate Session services. It also results in a SecureChannel which has no Channel Security" uri="http://opcfoundation.org/UA/SecurityPolicy#None" name="SecurityPolicy - None">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Security None"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Security None CreateSession ActivateSession"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  </Profile>
  <Profile category="Server" description="includes the ConformanceUnits when supporting Standard DataChange Subscription functionality." uri="http://opcfoundation.org/UA-Profile/Server/StandardDataChangeSubscription" name="Standard DataChange Subscription Server Facet">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Method Call"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor Items Deadband Filter"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor Items 10"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor Items 100"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor MinQueueSize_02"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor Triggering"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Subscription Minimum 02"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Subscription Publish Min 05"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Base Info GetMonitoredItems Method"/>
   </IncludeConformanceUnits>
   <IncludeProfiles>
    <IncludeProfile name="Embedded DataChange Subscription Server Facet"/>
   </IncludeProfiles>
  ...
  <Profile category="Server" description="This Facet specifies the standard support for subscribing to events and is intended to supplement any of the full featured Server Profiles. Support of this Facet requires the implementation of Event Types representing the Events that the Server can report and their specific fields. " uri="" name="Standard Event Subscription Server Facet">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Base Info Progress Events"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Base Info System Status"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Base Info Property Change"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Base Info EventQueueOverflowEventType"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor Basic"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor Items 10"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor QueueSize_ServerMax"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor Events"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Monitor Complex Event Filter"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Subscription Basic"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Subscription Minimum 02"/>
  ...
  <Profile category="Server" description="defines the most common functionality for OPC UA Servers." uri="http://opcfoundation.org/UA-Profile/Server/StandardUA" name="Standard UA Server">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Session Cancel"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Session Minimum 50 Parallel"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="View Minimum Continuation Point 05"/>
    <IncludeConformanceUnit optional="false" group="View Services" name="Attribute Write StatusCode &amp; TimeStamp"/>
   </IncludeConformanceUnits>
   <IncludeProfiles>
    <IncludeProfile name="Enhanced DataChange Subscription Server Facet"/>
    <IncludeProfile name="Embedded UA Server Profile"/>
   </IncludeProfiles>
  </Profile>
  <Profile category="Transport" description="defines a Stack Profile which represents the combination of UA TCP 1.0, UA SecureConversation 1.0 and UA Binary 1.0 encoding." uri="http://opcfoundation.org/UA-Profile/Transport/uatcp-uasc-uabinary" name="UA-TCP UA-SC UA Binary">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Protocol TCP Binary UA Security"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  </Profile>
  <Profile category="Server" description="indicates that a user token that is comprised of a username and password is supported." uri="http://opcfoundation.org/UA-Profile/Security/UserToken/Server/UserNamePassword" name="User Token - User Name Password Server Facet">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Security User Name Password"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  </Profile>
  <Profile category="Server" description=" indicates that the use of an X509 certificates to identify users is supported" uri="" name="User Token - X509 Certificate Server Facet">
   <IncludeConformanceUnits>
    <IncludeConformanceUnit optional="false" group="View Services" name="Security User X509"/>
   </IncludeConformanceUnits>
   <IncludeProfiles/>
  </Profile>
 </Profiles>
